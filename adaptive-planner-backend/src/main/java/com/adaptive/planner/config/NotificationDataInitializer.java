    ...
    public void run(String... args) {
        if (notificationRepository.count() == 0) {
            ...
            NotificationEntity n1 = NotificationEntity.builder()
                    ...
                    .type("AI_SUGGESTION")
                    .priority("NORMAL")
                    .title("Chào mừng bạn đến với Adaptive Planner!")
                    .message("Modo đã sẵn sàng đồng hành cùng bạn. Hệ thống sẽ tự động theo dõi lịch trình, bảo vệ thời gian nghỉ ngơi và thông báo khi có xung đột giờ.")
            ...
            NotificationEntity n2 = NotificationEntity.builder()
                    ...
                    .priority("HIGH")
                    .title("Gợi ý tái cân bằng lịch trình")
                    .message("Hôm nay bạn có nhiều ca làm việc liên tiếp. Modo đã chuẩn bị sẵn phương án giãn đệm 15 phút an toàn để bảo vệ năng lượng nhận thức.")
            ...
            NotificationEntity n3 = NotificationEntity.builder()
                    ...
                    .type("BLOCK_STARTING")
                    .priority("NORMAL")
                    .title("Nhắc nhở: Ca làm việc tập trung sắp bắt đầu")
                    .message("Ca làm việc 09:00 sẽ bắt đầu sau 10 phút. Hãy chuẩn bị không gian yên tĩnh và một cốc nước.")
