...
function LabHeader({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-border bg-card/75 p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
      <button type="button" onClick={onExit} title="Back to home" className="flex items-center gap-3 text-left transition-opacity hover:opacity-80">
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
      <div className="flex h-[70px] items-center bg-primary px-5 text-primary-foreground shadow-sm sm:px-7">
        <button type="button" onClick={onExit} title="Back to home" className="flex min-w-[210px] items-center gap-2.5 text-left transition-opacity hover:opacity-80">
      ...
      <div className="grid min-h-[calc(100vh-70px)] lg:grid-cols-[230px_minmax(0,1fr)]">
        ...
        <section className="relative min-h-[calc(100vh-70px)] overflow-hidden bg-background">
          <div className="px-7 pb-40 pt-9 sm:px-12 lg:px-16 lg:pt-12">
          ...
          <div className="absolute inset-x-6 bottom-5 flex items-end justify-between gap-4 sm:inset-x-10 lg:inset-x-16">
            <RecorderCard
              videoRef={videoRef}
...
function RecorderCard({
  ...
  return (
    <div className="w-[220px] shrink-0 overflow-hidden rounded-xl border border-border bg-card shadow-xl shadow-foreground/15">
      ...
      {hasRecording && (
        <div className="border-t border-border px-3 py-2 font-sans text-[10px] text-muted-foreground">
          {realRecording ? "Video answer ready for review." : "Demo answer saved."}
        </div>
      )}
    </div>
  );
      ...
      <div className="grid gap-5 lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <div className="space-y-5">
          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
            <section className="overflow-hidden rounded-2xl border border-[#1e293b] bg-[#0f172a] text-white shadow-xl shadow-slate-950/20">
            ...
            <section className="rounded-2xl border border-border bg-card/75 p-5 shadow-sm">
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                <Button className="rounded-lg" onClick={() => setSaved(true)} disabled={!score}>
