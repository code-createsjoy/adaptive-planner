...
export const SensoryModeSwitcher: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  const modes: {
  ...
  }[] = [
    {
      ...
      shortDesc: 'Visual de-cluttering • Now + Next tasks only • Soothing',
    ...
    },
    {
      ...
      shortDesc: 'Default profile • Balanced overview',
    ...
    },
    {
      ...
      shortDesc: 'Single active task • Hide distractions • Focus timer',
